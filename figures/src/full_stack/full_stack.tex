...
\tikzset{
  learn/.style={
    ...
    font=\sffamily\small, text=axiscolor,
  },
  norm/.style={
  ...
  hd/.style={font=\sffamily\small, text=c1, anchor=south},
  shp/.style={font=\sffamily\small, text=labelcolor, anchor=north},
  op/.style={font=\sffamily\small, text=axiscolor},
  lab/.style={font=\sffamily\small, text=labelcolor},
...
\foreach \p/\w in {1/The, 2/cat, 3/chased, 4/the, 5/mouse} {
    ...
    \node[font=\sffamily\small, anchor=east] at (1.05, \y)
        {\textcolor{labelcolor}{(\p)}\;\textcolor{c1}{\w}};
}
\foreach \p/\id in {1/464, 2/3797, 4/262, 5/10211} {
    ...
    \node[draw=c1, line width=0.7pt, fill=c1, fill opacity=0.10,
          ...
          font=\sffamily\small, text=c1] at (1.65, \y) {\id};
}
...
\node[hd, text=labelcolor] at (7.01, 4.42) {$5 \times 9$};
\foreach \p in {1,...,5} {
    \pgfmathsetmacro{\y}{\ry{\p}}
    \foreach \c in {0,...,8} {
...
\node[font=\sffamily\large, text=labelcolor] at (12.35, \sy) {$\cdots$};
...
\node[hd, text=labelcolor] at (20.45, 4.42) {$5 \times \lvert\mathcal{V}\rvert$};
\foreach \p in {1,2,4,5} {
    \pgfmathsetmacro{\y}{\ry{\p}}
...
\node[font=\sffamily\small, text=c1, anchor=east] at (21.50, -0.95)
...
\foreach \k/\w/\v in {0/the/0.55, 1/a/0.12, 2/mouse/0.09, 3/cat/0.07,
    ...
    \else
        ...
        \node[font=\sffamily\small, text=c1, anchor=north]
            at (\x, \base-0.10) {\w};
    \fi
}
...
\node[font=\sffamily\small, text=labelcolor, anchor=north, align=center]
